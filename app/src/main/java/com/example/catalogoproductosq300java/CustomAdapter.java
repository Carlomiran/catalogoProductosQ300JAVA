package com.example.catalogoproductosq300java;
...
public class CustomAdapter extends ArrayAdapter<Producto> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        builder.build().load("http://proyectofinal.eastus2.cloudapp.azure.com/"+myData.get(position).getImagen()).into(productoImg);
